...
<?php $this->load->view('template/popup_chat');?>
...
<!--CUSTOM CODES-->
<script src="<?php echo base_url();?>app/custom/chat.js"></script>
<script src="<?php echo base_url();?>app/custom/modal-custom.js"></script>
<script src="<?php echo base_url();?>app/custom/group-modal.js"></script>
<!--end of CUSTOM CODES-->
